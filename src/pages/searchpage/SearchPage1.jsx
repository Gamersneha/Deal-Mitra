...
const colors = [
  "Blue", "Red", "Brown", "Pink", "Silver", "Purple",
  "Yellow", "Orange", "Black", "Gray", "White", "Green",
];
...
export default function SearchPage() {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    const matchesCategory = selectedFilter ? product.category === selectedFilter : true;
    const matchesColor = selectedColor.length > 0 ? selectedColor.includes(product.color) : true;
